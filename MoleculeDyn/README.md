...
similar for other molecules follow the scripts in [scripts/train/md17/equiformer/se_l2](https://github.com/StefanosPert/EquivariantOptimizationCR/tree/main/MoleculeDyn/scripts/train/md17/equiformer/se_l2)
